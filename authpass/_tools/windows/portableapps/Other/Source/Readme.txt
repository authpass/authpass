...
user in an INI file next to AuthPassPortable.exe called AuthPassPortable.ini.
...
copy AppNamePortable.ini from this directory to AuthPassPortable.ini next to
AuthPassPortable.exe. The options in the INI file are as follows:
