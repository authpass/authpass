...
class _$AnalyticsEvents extends AnalyticsEvents with AnalyticsEventStubsImpl {
  ...
  void trackOpenFile2({required String generator, required String version}) =>
      trackEvent('openFile2', <String, Object?>{
        'generator': generator,
        'version': version,
      });
  ...
  void trackSelectEntry({EntrySelectionType? type}) =>
      trackEvent('selectEntry', <String, Object?>{'type': type.toString()});
  ...
  }) => trackEvent('saveConflict', <String, Object?>{
    'type': type,
    'value': value,
    'success': success,
  });
  ...
  void trackSaveCount({required String? generator, required int value}) =>
      trackEvent('saveCount', <String, Object?>{
        'generator': generator,
        'value': value,
      });
  ...
  void trackAttachmentAction(String action, {String category = 'attachment'}) =>
      trackEvent('attachmentAction', <String, Object?>{
        'action': action,
        'category': category,
      });
  ...
  void _trackPreferences({
    ...
    required String to,
    String? category,
  }) => trackEvent('preferences', <String, Object?>{
    'action': action,
    'to': to,
    'category': category,
  });
  ...
  }) => trackEvent('autofillSelect', <String, Object?>{
    'category': category,
    'action': action,
  });
